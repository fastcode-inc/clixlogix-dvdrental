...
import com.fastcode.dvdrentalclixlogix.domain.core.film.QFilmEntity;
...
public class FilmAppService implements IFilmAppService {
    ...
    public CreateFilmOutput create(CreateFilmInput input) {
        ...
        if (input.getLanguageId() != null) {
            foundLanguage =
                _languageRepository.findById(Integer.parseInt(input.getLanguageId().toString())).orElse(null);
