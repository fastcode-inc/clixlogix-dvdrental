...
import com.fastcode.dvdrentalclixlogix.domain.core.filmcategory.QFilmCategoryEntity;
...
public class FilmCategoryAppService implements IFilmCategoryAppService {
    ...
    public CreateFilmCategoryOutput create(CreateFilmCategoryInput input) {
        ...
        if (input.getCategoryId() != null) {
            foundCategory =
                _categoryRepository.findById(Integer.parseInt(input.getCategoryId().toString())).orElse(null);
