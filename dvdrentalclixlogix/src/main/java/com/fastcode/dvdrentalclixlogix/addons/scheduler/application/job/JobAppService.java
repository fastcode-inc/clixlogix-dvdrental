package com.fastcode.dvdrentalclixlogix.addons.scheduler.application.job;

import com.fastcode.dvdrentalclixlogix.DvdrentalclixlogixApplication;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.CGenClassLoader;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.application.job.dto.*;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.constants.QuartzConstants;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.domain.job.IJobRepository;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.domain.job.JobEntity;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.domain.jobhistory.IJobHistoryRepository;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.domain.jobhistory.JobHistoryEntity;
import com.fastcode.dvdrentalclixlogix.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
...
public class JobAppService implements IJobAppService {
    ...
    public List<String> listAllJobClasses() throws URISyntaxException {
        ...
        URI uri = DvdrentalclixlogixApplication.class.getResource("/").toURI();
